...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'Agenor site') }}</title>
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-white-100 bg-white-900">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
